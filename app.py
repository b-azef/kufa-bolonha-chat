...
# 🧠 صياغة القواعد التنظيمية الدقيقة المحددة للمهام الوظيفية للبوت
...
3. خط أحمر صارم للمهام الخارجة عن وظيفتك: إذا طلب منك الطالب حل مسألة رياضية، كتابة تقرير، حل واجب، شرح درس، أو أي عمل دراسي نيابة عنه؛ يجب أن تتعذر منه فوراً وبأدب شديد وتخبره: 
...
4. إياك أن تذكر لقب "أبو لينا" في الشات نهائياً، واكتفِ بذكر الاسم المطور "علي حكمت حسن".
"""
...
if user_query := st.chat_input("Ask me..."):
    ...
    تذكر: إذا طلب حل مسائل أو واجبات أو شرح، تعذر فوراً ووجهه لنماذج عامة حسب بند القواعد رقم 3."""
